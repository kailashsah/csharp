...
namespace UserListDemo
{
    internal class UserModalViewModel : INotifyPropertyChanged
    {
        ...
        public UserModalViewModel(IMainWindowViewModel mainWindowViewModel, UserModel userModel, IClose closableWindow)
        {
        ...
        private void CreateOrUpdate(object obj)
        {
            if (_isInEditMode)
            {
                var result = _mainWindowViewModel.UserListViewModel.UpdateUser(new UserModel()
                {
                    Name = Name,
                    Age = Age,
                    Id = _userModel.Id
            ...
            {
                var result = _mainWindowViewModel.UserListViewModel.AddUser(new UserModel()
                {
                    Name = Name,
                    Age = Age,
                });
